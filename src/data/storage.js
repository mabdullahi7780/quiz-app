...
//   let key = `${localStorage.getItem("username")}'s_data`;
//   let total_user_score = answers.reduce((total, answerIdx, questionIdx) => {
...
//   }
//   all_users.push(localStorage.getItem("username"));
...
//   all_users.map((user) => {
//     key = `${user}'s_data`
//     user_data = JSON.parse(localStorage.getItem(key));
